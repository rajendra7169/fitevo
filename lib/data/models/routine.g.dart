...
const RoutineSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {
    r'RoutineDay': RoutineDaySchema,
    r'RoutinePlanItem': RoutinePlanItemSchema
  },
  getId: _routineGetId,
...
int _routineEstimateSize(
  ...
  {
    final offsets = allOffsets[RoutineDay]!;
    for (var i = 0; i < object.days.length; i++) {
      final value = object.days[i];
      bytesCount += RoutineDaySchema.estimateSize(value, offsets, allOffsets);
    }
  }
  {
...
void _routineSerialize(
  ...
  writer.writeObjectList<RoutineDay>(
    offsets[1],
    allOffsets,
    RoutineDaySchema.serialize,
    object.days,
  );
...
Routine _routineDeserialize(
  ...
  object.days = reader.readObjectList<RoutineDay>(
        offsets[1],
        RoutineDaySchema.deserialize,
        allOffsets,
        RoutineDay(),
      ) ??
      [];
...
P _routineDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectList<RoutineDay>(
            offset,
            RoutineDaySchema.deserialize,
            allOffsets,
            RoutineDay(),
...
extension RoutineQueryObject
    on QueryBuilder<Routine, Routine, QFilterCondition> {
  QueryBuilder<Routine, Routine, QAfterFilterCondition> daysElement(
      FilterQuery<RoutineDay> q) {
    return QueryBuilder.apply(this, (query) {
...
extension RoutineQueryProperty
  ...
  QueryBuilder<Routine, List<RoutineDay>, QQueryOperations> daysProperty() {
    return QueryBuilder.apply(this, (query) {
...
const RoutineDaySchema = Schema(
  name: r'RoutineDay',
  id: -3121452008665150293,
  properties: {
    r'isRest': PropertySchema(
      id: 0,
      name: r'isRest',
      type: IsarType.bool,
    ),
...
int _routineDayEstimateSize(
  ...
  {
    final offsets = allOffsets[RoutinePlanItem]!;
    for (var i = 0; i < object.items.length; i++) {
      final value = object.items[i];
      bytesCount +=
          RoutinePlanItemSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  bytesCount += 3 + object.name.length * 3;
  return bytesCount;
...
void _routineDaySerialize(
  ...
  writer.writeBool(offsets[0], object.isRest);
  writer.writeObjectList<RoutinePlanItem>(
    offsets[1],
    allOffsets,
    RoutinePlanItemSchema.serialize,
    object.items,
  );
...
RoutineDay _routineDayDeserialize(
  ...
  object.isRest = reader.readBool(offsets[0]);
  object.items = reader.readObjectList<RoutinePlanItem>(
        offsets[1],
        RoutinePlanItemSchema.deserialize,
        allOffsets,
        RoutinePlanItem(),
      ) ??
      [];
  object.name = reader.readString(offsets[2]);
  object.weekday = reader.readLong(offsets[3]);
  return object;
}
...
P _routineDayDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readBool(offset)) as P;
    case 1:
      return (reader.readObjectList<RoutinePlanItem>(
            offset,
            RoutinePlanItemSchema.deserialize,
            allOffsets,
            RoutinePlanItem(),
...
extension RoutineDayQueryFilter
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> isRestEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isRest',
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> itemsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'items',
        0,
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> weekdayEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'weekday',
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> weekdayLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> weekdayBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension RoutineDayQueryObject
    on QueryBuilder<RoutineDay, RoutineDay, QFilterCondition> {
  QueryBuilder<RoutineDay, RoutineDay, QAfterFilterCondition> itemsElement(
      FilterQuery<RoutinePlanItem> q) {
    return QueryBuilder.apply(this, (query) {
...
const RoutinePlanItemSchema = Schema(
  name: r'RoutinePlanItem',
  id: 1545498215984574571,
  properties: {
  ...
  estimateSize: _routinePlanItemEstimateSize,
  serialize: _routinePlanItemSerialize,
  deserialize: _routinePlanItemDeserialize,
  deserializeProp: _routinePlanItemDeserializeProp,
);

int _routinePlanItemEstimateSize(
  RoutinePlanItem object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _routinePlanItemSerialize(
  RoutinePlanItem object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
P _routinePlanItemDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension RoutinePlanItemQueryFilter
    on QueryBuilder<RoutinePlanItem, RoutinePlanItem, QFilterCondition> {
  ...
  QueryBuilder<RoutinePlanItem, RoutinePlanItem, QAfterFilterCondition>
      targetRepsHighEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'targetRepsHigh',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<RoutinePlanItem, RoutinePlanItem, QAfterFilterCondition>
      targetRepsLowEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'targetRepsLow',
        value: value,
      ));
    });
  }
...
extension RoutinePlanItemQueryObject
    on QueryBuilder<RoutinePlanItem, RoutinePlanItem, QFilterCondition> {}
